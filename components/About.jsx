...
const infoData = [
  ...
  },
  {
    ...
    text: "samgifford.work@gmail.com",
  },
  {
    icon: <GraduationCap size={20} />,
    text: "Higher Education Diploma of Information Technology",
  },
  {
    icon: <HomeIcon size={20} />,
    text: "Hervey Bay, QLD, Australia",
  },
];
...
const About = () => {
  ...
  return (
    <section className="mt-50 xl:h-[860px] pb-12 xl:py-24">
                ...
                <TabsContent value="personal">
                  <div className="text-center xl:text-left">
                    <h3 className="h3 mb-4">
                      Junior Developer | Dad | Code Enthusiast
                    </h3>
                    <p className="subtitle max-w-xl mx-auto xl:mx-0">
                      Tech enthusiast with a Higher Education Diploma in IT,
                    ...
                    <div className="flex flex-col gap-y-2">
                      <div className="text-primary">Language(s) spoken</div>
